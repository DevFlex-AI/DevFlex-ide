...
export const register = async () => {
	...
	statusBarItem.accessibilityInformation = { label: 'DevFlex Status', role: 'status' };
	statusBarItem.tooltip = 'DevFlex Status';
	statusBarItem.name = 'DevFlex Status';
	statusBarItem.text = '$(copilot)';
	statusBarItem.command = 'DevFlex.status.icon.menu';
	statusBarItem.show();
