...
const chatRequestHandler: vscode.ChatExtendedRequestHandler = async (request, context, response, token) => {
	try {
		...
		const returnTokenUsage = vscode.workspace.getConfiguration().get<boolean>('DevFlex.inlineChat.showTokenUsage');
...
export const register = async () => {
	...
	chatParticipant = vscode.chat.createChatParticipant('DevFlex.editor.default', chatRequestHandler);
