...
const chatRequestHandler: vscode.ChatExtendedRequestHandler = async (request, context, response, token) => {
	...
	try {
		...
		const returnTokenUsage = vscode.workspace.getConfiguration().get<boolean>('DevFlex.editingSession.showTokenUsage');
...
export const register = async () => {
	...
	chatParticipant = vscode.chat.createChatParticipant('DevFlex.editing.session', chatRequestHandler);
