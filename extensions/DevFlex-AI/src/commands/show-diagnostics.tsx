...
/**
 * Registers the `DevFlex.show.diagnostics` command with the VS Code extension context.
 */
export const registerShowDiagnosticsCommand = () => {
	registerDisposable(
		vscode.commands.registerCommand('DevFlex.show.diagnostics', handler)
	);
	logger.info('Command `DevFlex.show.diagnostics` registered');
};
